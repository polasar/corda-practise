...
public class ExampleClientRPC {
    ...
    public static void main(String[] args) throws ActiveMQException, InterruptedException, ExecutionException {
        ...
        final DataFeed<Vault.Page<RepoAllege>, Vault.Update<RepoAllege>> dataFeed = proxy.vaultTrack(RepoAllege.class);
        final Vault.Page<RepoAllege> snapshot = dataFeed.getSnapshot();
        final Observable<Vault.Update<RepoAllege>> updates = dataFeed.getUpdates();
